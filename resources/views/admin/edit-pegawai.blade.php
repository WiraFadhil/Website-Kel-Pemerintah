...
<body class="bg-gray-100">
                        ...
                        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                            <div class="p-6 sm:p-8">
                                <div class="mb-8">
                                    ...
                                    <p class="text-gray-500 mt-1">Perbarui detail pegawai pada form di bawah ini.</p>
                                </div>
                                ...
                                <form action="{{ route('admin.pegawai.update', $pegawai->id) }}" method="POST"
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                                        ...
                                        <div>
                                            ...
                                            <div class="input-icon-wrapper">
                                                ...
                                                <input type="text" name="nip" id="nip"
                                                    ...
                                                    placeholder="cth: 199001012020011001">
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="input-icon-wrapper">
                                                ...
                                                <input type="number" name="urutan" id="urutan"
                                                    class="input-field block w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                                    value="{{ old('urutan', $pegawai->urutan) }}" required>
                                            </div>
                                        </div>
                                            ...
                                            <div class="input-icon-wrapper">
                                                ...
                                                <select name="parent_id" id="parent_id"
                                                    ...
                                                    @foreach ($pegawais as $p)
                                                        <option value="{{ $p->id }}"
                                                            {{ old('parent_id', $pegawai->parent_id) == $p->id ? 'selected' : '' }}>
                                                            {{ $p->nama }} - {{ $p->jabatan }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="md:col-span-2">
                                            <label class="block font-medium text-sm text-gray-700 mb-1">Ganti Foto
                                                (Opsional)</label>
                                            <div class="mt-2 flex items-center gap-4">
                                                <img id="foto-preview"
                                                    src="{{ $pegawai->foto ? Storage::url($pegawai->foto) : 'https://placehold.co/100x100/e2e8f0/a0aec0?text=Preview' }}"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const sidebar = document.getElementById('sidebar'); // Pastikan ID ini ada di layouts.aside
