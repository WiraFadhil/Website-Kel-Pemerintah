...
<body class="bg-gray-100">
    ...
    {{-- 1. Hapus kelas 'overflow-hidden' dari div ini --}}
    <div class="flex h-screen">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <header class="bg-white shadow-md p-4 flex justify-between items-center">
                ...
                <h2 class="text-2xl font-bold text-gray-800">Tambah Slider</h2>
            ...
            {{-- 2. Tambahkan kelas 'flex-1' dan 'overflow-y-auto' ke div konten utama ini --}}
            <div class="flex-1 overflow-y-auto scrollbar-hide container mx-auto p-8 max-w-3xl">
                <h1 class="text-3xl font-bold text-gray-800 mb-6">Add New Slider</h1>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="button_color_class" id="button_color_class"
                                    value="{{ old('button_color_class', 'bg-blue-600 hover:bg-blue-700') }}"
                                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3"
                                    required>
